...
public class StatusBarCompat {
    ...
    public static void getTranslucentForCollapsingToolbarLayout(final Context context, final Toolbar toolbar){
        if (toolbar!=null){
            toolbar.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
                ...
                public void onGlobalLayout() {
                    ...
                    toolbar.getLayoutParams().height=toolbar.getHeight()+getStatusBarHeight(context);
                }
            });
        }
    }
